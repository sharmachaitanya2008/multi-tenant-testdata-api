...
public class DataSourceConfig {
    ...
    public DataSource routingDataSource() {
        ...
        List<Map<String, String>> envs = binder.bind("app.environments", List.class).orElse(null);
        ...
        if (envs != null) {
            for (Map<String, String> cfg : envs) {
                ...
                String url = cfg.get("url"); String user = cfg.get("username"); String pass = cfg.get("password");
